    ...
    <nav class="navbar navbar-expand-lg navbar-light p-1 " style="font-size: 20px;background-color: white;">
        <div class="container-fluid mt-3">
            <a class="navbar-brand" href="/inicio"
                style="margin-left: 10%;size: 25px;font-weight: bold; color: #bfba5;">HELP A
                MOVIE</a>
                ...
                <ul class="navbar-nav">
                    ...
                    @auth
                        <a id="login-register-button" class="nav-link me-4" href="/profile"
                            style="font-weight: 10px;margin-top: 1.4%">You</a>
                    @else
                        <li style="list-style: none; margin-top: 2%">
                            <a id="login-register-button" class="me-4" href="{{ route('login') }}"
                                id="login-register-button">Login</a>
                        </li>
                        <li style="list-style: none; margin-top: 2%">
        ...
        <div class="row">
            <div class="col-md-offset-1 col-md-10 col-sm-12">
                <div class="blog-post-thumb">
                    <div class="blog-post-image">
                        <a href="single-post.html">
                            <img src="https://images.pexels.com/photos/65437/pexels-photo-65437.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                    ...
                    <div class="blog-post-des">
                        <p>
                            At our crowdfunding platform, we are dedicated to empowering creators and providing them
                            with a global platform to showcase their innovative projects. We believe in nurturing their
                            talent and helping them bring their ideas to life. By supporting these creators, we aim to
                            amplify their voices and connect them with a wide audience, propelling their projects to new
                            heights. Together, let's foster a community that celebrates creativity, fuels inspiration,
                            and enables visionary storytellers to shine.
                        </p>
                ...
                <div class="blog-post-thumb">
                    <div class="blog-post-image">
                        <a href="single-post.html">
                            <img src="https://images.pexels.com/photos/7991579/pexels-photo-7991579.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                class="img-responsive" alt="Blog Image">
                        </a>
                    </div>
                    <div class="blog-post-title">
                    ...
                    <div class="blog-post-des">
                        <p>Our mission is to revolutionize the way talented individuals in the creative industry gain
                            exposure and funding for their projects. Through our crowdfunding platform, we offer
                            creators a powerful avenue to showcase their work, secure vital investments, and generate
                            buzz. By investing in these exceptional talents, we not only provide them with the necessary
                            financial support but also leverage our extensive marketing and advertising network to
                            ensure their projects receive the attention they deserve. Together, let's unlock the
                            potential of aspiring creators, amplify their reach, and shape the future of the
        ...
        <div class="row justify-content-center align-items-center ">
            ...
            <div class="col-md-4 col-md-offset-1 col-sm-6">
                ...
                <p><svg style="color: white" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    </svg></i> latifa.elkadiri01@gmail.com</p>
            </div>
        </div>
