...
<header>
    <nav class="navbar navbar-expand-lg navbar-light p-1 pb-3" style="font-size: 20px; background-color: black;">
        <div class="container-fluid mt-3">
            <a class="navbar-brand" href="/inicio" style="margin-left: 10%; font-size: 25px; font-weight: bold; color: white;">HELP A MOVIE</a>
            ...
            <div class="collapse navbar-collapse ps-3" style="margin-left: 40%" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-4" href="/peliculas" style="color: white;">Movies</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link me-4" href="/usuarios" style="color: white;">Profiles</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link me-4" href="/chatify" style="color: white;">Chats</a>
                    </li>
                    @auth
                    <a id="login-register-button" class="nav-link me-4" href="/profile" style="font-weight: 10px; color: white;">You</a>
                    @else
                    <li style="list-style: none">
                        <a id="login-register-button" href="{{ route('login') }}" id="login-register-button" style="color: white;">Login</a>
                        @if (Route::has('register'))
                        <a id="login-register-button" href="{{ route('register') }}" style="color: white;">Register</a>
                        @endif
                    </li>
                    @endauth
                </ul>
        ...
        <div class="container">
            ...
            <div class="col-md-12 col-sm-12">
                <ul class="social-icon">
                    ...
                    <li><a href="#" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-spotify" viewBox="0 0 16 16">
