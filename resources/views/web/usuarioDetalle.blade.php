@extends('web.layout')
@section('main')
<link rel="stylesheet" href="{{ asset('css2/unusuario.css') }}">
    ...
    <div class="container mb-5">
        ...
        <div class="container d-flex justify-content-center align-items-center">
            <div class="card" style="max-width: 30rem;">
              <img src="{{ asset('storage/users-avatar/' . $user->avatar) }}" class="card-img-top image-fade" alt="...">
              <div class="card-body text-center">
                <h5 class="card-title">{{ strtoupper($user->name) }}</h5>
                <p class="card-text" style="font-weight: bolder">{{ ucfirst($user->rol) }} | {{ $user->genero }}</p>
                ...
                <div class="movie-card__cast text-center">
                  ...
                  <div class="movie-card__cast-members d-flex justify-content-center">
                    ...
                    @foreach ($peliculas as $pelicula)
                      <a href="/peliculas/{{ $pelicula->id }}" data-tooltip="{{ $pelicula->titulo }}" data-placement="top">
                        <img src="{{ asset( $pelicula->imagen) }}" alt="Película" class="image-fade movie-card__cast-member">
                      </a>
                    @endforeach
                  </div>
                </div>
