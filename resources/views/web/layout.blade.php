...
<header>
    <div class="flex">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link" href="#">EMPIEZA UN PROYECTO</a>
                    ...
                    @else
                        <li style="list-style: none">
                            <a id="login-register-button" href="{{ route('login') }}"
        ...
        <nav class="navbar navbar-expand-lg" style="border-top: 1px solid grey;border-bottom: 1px solid grey" >
            <div class="container-fluid">
                <a class="navbar-brand" href="#">HELP A MOVIE</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                    data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false"
                    aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link" href="/peliculas">CINE</a>
                ...
                <div class="container text-center text-md-start mt-5">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                            ...
                            <p>
                                Help a movie es una página en donde podrás planear con tus amigos distintos torneos,
                                unirte, conocer nuevos grupos y
                        ...
                        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p>
                                <a class="text-reset" aria-current="page" href="/juegos">MOVIES</a>
                            </p>
                            <p>
                                <a class="text-reset" aria-current="page" href="/torneos">CHATS</a>
                            </p>
